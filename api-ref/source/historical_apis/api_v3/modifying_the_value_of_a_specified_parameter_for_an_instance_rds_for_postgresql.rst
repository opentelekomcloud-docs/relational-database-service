...
.. table:: **Table 3** Parameters
   ...
   | Parameter       | Mandatory       | Type            | Description                                                                                                                                                                                                                                                                                                                                |
   +=================+=================+=================+============================================================================================================================================================================================================================================================================================================================================+
   | value           | Yes             | String          | Name of the extension to be preloaded. The following extensions can be preloaded: pg_cron, pg_stat_statements, pg_qualstats, pg_stat_kcache, pg_wait_sampling, pgaudit, timescaledb, pglogical, passwordcheck.so, pg_sql_history, auth_delay, pg_hint_plan, anon, rds_pg_sql_ccl, pg_stat_monitor, pg_tle, and rds_performance_statements. |
   |                 |                 |                 |                                                                                                                                                                                                                                                                                                                                            |
   |                 |                 |                 | The value must contain the passwordcheck.so, pg_stat_statements, pg_sql_history, and pgaudit extension names.                                                                                                                                                                                                                              |
   +-----------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
