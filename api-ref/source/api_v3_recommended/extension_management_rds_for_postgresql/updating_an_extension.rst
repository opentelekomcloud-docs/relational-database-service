...
This API is used to update an extension on a specified database.
...
Update the extension **pg_stat_statements** for database **db1**.

.. code-block:: text

   PUT https://rds.eu-de.otc.t-systems.com/v3/0483b6b16e954cb88930a360d2c4e663/instances/dsfae23fsfdsae3435in03/extensions
   {
      "database_name" : "db1",
