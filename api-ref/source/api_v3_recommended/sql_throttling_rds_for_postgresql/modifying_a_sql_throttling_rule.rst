:original_name: rds_20_0003.html
...
This API is used to modify a SQL throttling rule.
...
-  URI format
   ...
   PUT https://{*Endpoint*}/v3/{project_id}/instances/{instance_id}/sql-limit/update
...
Modify a SQL throttling rule.

.. code-block:: text

   PUT https://rds.eu-de.otc.t-systems.com/v3/0483b6b16e954cb88930a360d2c4e663/instances/49b9dd1d6f464ba4bc91df5cbd2e52ebin03/sql-limit/update
   {
      "db_name" : "postgres",
      "id" : "1",
      "max_concurrency" : 10,
