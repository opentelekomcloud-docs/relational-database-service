...
#. On the **Instances** page, locate the target DB instance, or click |image2| and then locate the target read replica. Choose **More** > **Reboot** in the **Operation** column.
   ...
   Alternatively, click the target DB instance on the **Instances** page to go to the **Summary** page. Click |image3| and choose **Reboot** in the upper right corner.
...
.. |image2| image:: /_static/images/en-us_image_0000002459664204.png
.. |image3| image:: /_static/images/en-us_image_0000002514985127.png
