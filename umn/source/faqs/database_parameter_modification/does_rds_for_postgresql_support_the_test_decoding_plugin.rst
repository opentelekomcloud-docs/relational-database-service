...
PostgreSQL 12 supports test_decoding. For more information about test_decoding, see `test_decoding introduction <https://www.postgresql.org/docs/11/test-decoding.html>`__.
