...
#. Obtain the installation package.
   ...
   Find the `link <https://downloads.mysql.com/archives/community/>`__ to the required version on the download page. mysql-community-client-8.0.26-1.el8.x86_64.rpm is used as an example in the following figure.
